...
from models.documents import FinancialDocument, ParseStatus, ParseMethod
...
async def _ingest_mf_transactions(
    ...
    """
    from models.transactions import Transaction, TransactionSource, TransactionType
    import hashlib
...
async def ingest_cams_kfintech_from_parsed(
    ...
    """
    from models.documents import FinancialDocument, ParseStatus

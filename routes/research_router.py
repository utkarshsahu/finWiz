...
async def ingest_url(url: str = Form(...)):
    ...
    from integrations.research_ingester import ingest_url as _ingest
...
async def ingest_rss(max_items: int = Query(default=5, le=50)):
    ...
    from integrations.research_ingester import ingest_rss_feeds
...
async def ingest_pdf(file: UploadFile = File(...)):
    ...
    try:
        from integrations.research_ingester import ingest_pdf as _ingest

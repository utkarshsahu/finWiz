...
from app.integrations.amfi_fetcher import fetch_amfi_navs, AmfiNavData
from app.integrations.market_fetcher import (
...
from app.models.instruments import Instrument, AssetClass, Exchange

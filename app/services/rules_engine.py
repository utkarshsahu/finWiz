...
async def _upsert_signal(
    ...
    """
    from app.models.signals import Signal, SignalType, SignalSeverity
...
class RulesEngine:
    ...
    async def check_allocation_drift(self, snapshot: dict) -> int:
        ...
        """
        from app.models.signals import SignalType, SignalSeverity
    ...
    async def check_document_staleness(self) -> int:
        ...
        """
        from app.models.signals import SignalType, SignalSeverity
        from app.models.documents import FinancialDocument, DocType, ParseStatus
    ...
    async def check_policy_violations(self, snapshot: dict) -> int:
        ...
        """
        from app.models.signals import SignalType, SignalSeverity
        from app.models.policies import PolicyRuleType

...
# Routers
# ---------------------------------------------------------------------------
from app.routes.zerodha_router import router as zerodha_router
from app.routes.market_data_router import router as market_data_router
...
from app.routes.rules_router import router as rules_router
from app.routes.research_router import router as research_router
from app.routes.recommendations_router import router as recommendations_router
